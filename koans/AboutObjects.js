describe("About Objects", function () {
  ...
  it("should use prototype to add to all objects", function () {
    ...
    expect(simpleCircle.describe()).toBe("This circle has a radius of: " + simpleCircle.radius);
    expect(colouredCircle.describe()).toBe("This circle has a radius of: " + colouredCircle.radius);
  });
});
